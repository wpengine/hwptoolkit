		...
		<div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
			<div className="max-w-7xl mx-auto">
				<div className="mb-8">
					...
					<p className="text-gray-600">Welcome back, {customer?.displayName || customer?.firstName || "User"}</p>
				</div>
					...
					<div className="md:col-span-1">
						<nav className="bg-white rounded-lg shadow p-4 space-y-2">
							...
							<button
								...
								className={`w-full text-left px-4 py-3 rounded-md transition-colors ${
									activeTab === "account-details" ? "bg-blue-600 text-white" : "text-gray-700 hover:bg-gray-100"
								}`}
							>
								<span className="flex items-center">
									<svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
