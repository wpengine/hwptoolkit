...
export default function AddToCart({ product, card = null, quantity = 1, variation = null, variationId = null }: AddToCartProps) {
	...
	const hasVariations = product.variations?.nodes && product.variations.nodes.length > 0 || product.type === "VARIABLE";
	const isDisabled = isAdding || cartLoading;
	const inOutOfStock = product.stockStatus === "OUT_OF_STOCK";
