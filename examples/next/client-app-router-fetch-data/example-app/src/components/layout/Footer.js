        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <ul>
              ...
              <li className={menuItemClass}>
                <Link href="/category/sport" className={menuItemLinkClass}>
                  Sport
                </Link>
              </li>
              <li className={menuItemClass}>
                <Link href="/tag/interior-design" className={menuItemLinkClass}>
                  Interior Design
                </Link>
              </li>
              <li className={menuItemClass}>
                <Link
                  href="/category/sport/marathon"
          ...
          <div>
            ...
            <ul>
              ...
              <li className={menuItemClass}>
                <Link href="/events" className={menuItemLinkClass}>
                  Events
                </Link>
              </li>
            </ul>
