	...
	public static function register(): void {
		register_graphql_mutation( 'createWebhook', [ 
			'inputFields' => [ 
				...
				'content' => [ 
					'type' => 'String',
					'description' => __( 'The content/description of the webhook', 'wp-graphql-webhooks' ),
				],
				'eventTrigger' => [ 
					'type' => 'String',
			...
			'outputFields' => [ 
				'webhook' => [ 
					'type' => 'Webhook',
					'description' => __( 'The created webhook', 'wp-graphql-webhooks' ),
			...
			'mutateAndGetPayload' => function ($input, $context, $info) {
				...
				if ( ! current_user_can( 'manage_options' ) ) {
					throw new UserError( __( 'You do not have permission to create webhooks.', 'wp-graphql-webhooks' ) );
				}
				...
				if ( is_wp_error( $post_id ) ) {
					throw new UserError( __( 'Failed to create webhook.', 'wp-graphql-webhooks' ) );
				}
