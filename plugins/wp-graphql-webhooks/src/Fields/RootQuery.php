...
class RootQuery {
    ...
    public static function register(): void {
        ...
        register_graphql_field( 'RootQuery', 'webhooks', [
            ...
            'description' => __( 'List all registered webhooks.', 'wp-graphql-webhooks' ),
            'resolve'     => function() {
                $query = new \WP_Query([
        ...
        register_graphql_field( 'RootQuery', 'webhook', [
            'type'        => 'Webhook',
            'description' => __( 'Fetch a webhook by ID.', 'wp-graphql-webhooks' ),
            'args'        => [
                'id' => [
                    'type'        => Type::nonNull( Type::id() ),
                    'description' => __( 'The global ID of the webhook to retrieve.', 'wp-graphql-webhooks' ),
                ],
            ],
