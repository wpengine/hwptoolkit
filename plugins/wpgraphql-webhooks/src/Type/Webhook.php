...
class Webhook {
	...
	public static function register(): void {
		register_graphql_object_type( 'Webhook', [
			'description' => __( 'A Webhook configuration object.', 'graphql-webhooks' ),
			'fields' => [
				'id' => [
					'type' => 'ID',
					'description' => __( 'The global ID of the webhook.', 'graphql-webhooks' ),
				...
				'handlerConfig' => [
					'type' => 'String',
					'description' => __( 'Configuration for the handler.', 'graphql-webhooks' ),
					'resolve' => function ($webhook) {
