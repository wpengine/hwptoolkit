...
class Webhook {
	...
	public static function register(): void {
		register_graphql_object_type( 'Webhook', [ 
			'description' => __( 'A Webhook configuration object.', 'wpgraphql-webhooks' ),
			'fields' => [ 
				'id' => [ 
					'type' => 'ID',
					'description' => __( 'The global ID of the webhook.', 'wpgraphql-webhooks' ),
				...
				'handlerConfig' => [ 
					'type' => 'String',
					'description' => __( 'Configuration for the handler.', 'wpgraphql-webhooks' ),
					'resolve' => function ($webhook) {
