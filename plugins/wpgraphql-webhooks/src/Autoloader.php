...
class Autoloader {
	...
	public static function autoload(): bool {
		...
		if ( defined( 'WPGRAPHQL_WEBHOOKS_AUTOLOAD' ) && false === WPGRAPHQL_WEBHOOKS_AUTOLOAD ) {
			return true;
		}
	...
	protected static function missing_autoloader_notice(): void {
		$error_message = 'Webhooks for WPGraphQL: The Composer autoloader was not found. If you installed the plugin from the GitHub source, make sure to run `composer install`.';
