	...
	public static function register(): void {
		register_graphql_mutation( 'createWebhook', [ 
			'inputFields' => [ 
				'title' => [ 
					'type' => 'String',
					'description' => __( 'The title of the webhook', 'wpgraphql-webhooks' ),
				],
				'content' => [ 
					'type' => 'String',
					'description' => __( 'The content/description of the webhook', 'wpgraphql-webhooks' ),
				],
				'eventTrigger' => [ 
					'type' => 'String',
					'description' => __( 'The event hook name that triggers this webhook', 'wpgraphql-webhooks' ),
				],
				'enabled' => [ 
					'type' => 'Boolean',
			...
			'outputFields' => [ 
				'webhook' => [ 
					'type' => 'Webhook',
					'description' => __( 'The created webhook', 'wpgraphql-webhooks' ),
			...
			'mutateAndGetPayload' => function ($input, $context, $info) {
				...
				if ( ! current_user_can( 'manage_options' ) ) {
					throw new UserError( __( 'You do not have permission to create webhooks.', 'wpgraphql-webhooks' ) );
				}
				...
				if ( is_wp_error( $post_id ) ) {
					throw new UserError( __( 'Failed to create webhook.', 'wpgraphql-webhooks' ) );
				}
