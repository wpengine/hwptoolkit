...
if ( ! class_exists( 'WPGraphQL\Webhooks\Plugin' ) ) :
	...
	final class Plugin {
		...
		private function includes(): void {
			if (
				defined( 'WPGRAPHQL_WEBHOOKS_AUTOLOAD' )
				&& false !== WPGRAPHQL_WEBHOOKS_AUTOLOAD
				&& defined( 'WPGRAPHQL_WEBHOOKS_PLUGIN_DIR' )
			) {
				require_once WPGRAPHQL_WEBHOOKS_PLUGIN_DIR . 'vendor/autoload.php';
			}
		}
