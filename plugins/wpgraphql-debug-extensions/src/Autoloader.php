...
class Autoloader {
    ...
    public static function autoload(): bool {
        ...
        if ( defined( 'WPGRAPHQL_DEBUG_EXTENSIONS_AUTOLOAD' ) && false === WPGRAPHQL_DEBUG_EXTENSIONS_AUTOLOAD ) {
            return true;
        }
    ...
    protected static function missing_autoloader_notice(): void {
        $error_message = 'WPGraphQL Debug Extensions: The Composer autoloader was not found. If you installed the plugin from the GitHub source, make sure to run `composer install`.';
